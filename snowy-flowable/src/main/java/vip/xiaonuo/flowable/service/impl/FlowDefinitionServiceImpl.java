...
import vip.xiaonuo.flowable.dal.FwDeployMapper;
...
import vip.xiaonuo.flowable.service.IFlowDefinitionService;
...
public class FlowDefinitionServiceImpl extends FlowServiceFactory implements IFlowDefinitionService {
    ...
    @Resource
    private FwDeployMapper fwDeployMapper;
...
//         PageHelper.startPage(pageNum, pageSize);
        List<FlowProcDefDto> dataList = fwDeployMapper.selectDeployList(name);
        // 加载挂表单
    ...
    public AjaxResult startProcessInstanceById(String procDefId, Map<String, Object> variables) {
        try {
            // todo 设置【跳转条件】会把组件的布尔值转为String，可以在前端做一个转换，待定***
            variables.computeIfPresent("isWb", (k, v) -> {
                Boolean aBoolean = BooleanUtils.toBooleanObject(v.toString());
                variables.put("isZs", !BooleanUtils.toBooleanObject(v.toString()));
                return aBoolean;
            });
